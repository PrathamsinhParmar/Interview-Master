...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (data && data._id) {
            ...
            setError("Failed to generate interview strategy. Please check your credentials / AI configuration.")
        }
    }
                                ...
                                {selectedFile ? (
                                    <>
                                        <span className='dropzone__icon' style={{color: '#ff2d78'}}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                                        </span>
                                        <p className='dropzone__title'>{selectedFile.name}</p>
                                        <p className='dropzone__subtitle'>{(selectedFile.size / (1024 * 1024)).toFixed(2)} MB &bull; Click to change</p>
                                    </>
                                ) : (
                                    <>
