...
export function CardBody({ className = "", ...props }) {
  return <div role="group" className={`card-body ${className}`} {...props} />;
}
...
// Visual 1 Implementation
function Visual1({
  mainColor = "#249E94",
  secondaryColor = "#3BC1A8",
  gridColor = "rgba(255, 255, 255, 0.08)",
}) {
  return (
    <div aria-hidden className="visual-container">
...
const Layer3 = ({ color, secondaryColor }) => {
  return (
    <div className="layer-3" style={{ "--color": color, "--secondary-color": secondaryColor }}>
      <div className="pill">
        <div className="dot" style={{ backgroundColor: "var(--color)" }} />
        <span>Analyzed</span>
      </div>
      <div className="pill">
        <div className="dot" style={{ backgroundColor: "var(--secondary-color)" }} />
        <span>Matched</span>
      </div>
    </div>
  );
...
const Layer4 = () => {
  return (
    <div className="layer-4">
      <div className="layer-4-inner">
        <div className="layer-4-card">
          <p className="layer-4-title">Skills Extracted</p>
          <p className="layer-4-desc">Matching against 45 requirements.</p>
        </div>
      </div>
    </div>
  );
...
export default function AnimatedCardDemo() {
  return (
    <AnimatedCard>
      <CardVisual>
        <Visual1 mainColor="#249E94" secondaryColor="#3BC1A8" />
      </CardVisual>
      <CardBody>
        <CardTitle>AI Profile Analysis</CardTitle>
        <CardDescription>
          Seamlessly mapping your experience to the job requirements.
        </CardDescription>
      </CardBody>
    </AnimatedCard>
  );
